...
def login(username, password, url):
    while True:
        ...
        WebDriverWait(crack.browser, 30, 1).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".gt_slider_knob.gt_show")))
        WebDriverWait(crack.browser, 30, 1).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".gt_cut_bg.gt_show")))
        WebDriverWait(crack.browser, 30, 1).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".gt_cut_fullbg.gt_show")))
